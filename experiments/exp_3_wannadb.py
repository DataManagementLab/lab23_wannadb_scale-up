...
from datasets.aviation import aviation as dataset  # TODO: choose data set by changing 'aviation' to 'corona', 'countries', 'nobel', or 'skyscrapers'
...
if __name__ == "__main__":
    ...
    with ResourceManager() as resource_manager:
        ...
        for NUM_INTERACTIONS in range(0, 41, 3):
            ...
            for run, random_seed in enumerate(random_seeds):
                ...
                aset_pipeline = ASETPipeline([
                    ...
                    RankingBasedMatcher(
                        ...
                        max_num_feedback=NUM_INTERACTIONS,
                        len_ranked_list=10,
            ...
            # store the results
            ################################################################################################################
            path = os.path.join(os.path.dirname(__file__), "results", f"{dataset.NAME}", "feedback", f"{NUM_INTERACTIONS}")
